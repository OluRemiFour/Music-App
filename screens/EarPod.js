...
import { getEarPod } from "../constant/data";
import { CartContext } from "../constant/CartContext";

export default function Earpod() {
  const earpod = getEarPod();
  ...
  return (
    <View style={{ marginVertical: 30, marginHorizontal: 30, flex: 1 }}>
      ...
      <View style={{ marginVertical: 20 }}>
        <Text style={{ fontSize: 15, fontWeight: "semibold" }}>HD Earpods</Text>
      ...
      >
        ...
        >
          ...
          <View style={{ paddingTop: 15, paddingBottom: 10 }}>
            ...
            <Text style={{ fontSize: 15, color: "gray" }}>{price} N</Text>
            <Text
              style={{
                fontSize: 15,
                color: "gray",
